...
function getTemplates(templateKey) {
    if (templateKey === "autumn") {
        return [
            path_1.default.join(__dirname, "templates/autumn/autumn_1.jpg"),
            path_1.default.join(__dirname, "templates/autumn/autumn_2.jpg"),
            path_1.default.join(__dirname, "templates/autumn/autumn_3.jpg"),
            path_1.default.join(__dirname, "templates/autumn/autumn_4.jpg"),
        ];
    }
