...
export interface OrganizationRetrieveUsageResponse {
     ...
     */
    models: Array<'gen4.5' | 'gen3a_turbo' | 'gen4_turbo' | 'gen4_image' | 'gen4_image_turbo' | 'act_two' | 'gen4_aleph' | 'veo3' | 'veo3.1' | 'veo3.1_fast' | 'gemini_2.5_flash' | 'eleven_multilingual_v2' | 'eleven_text_to_sound_v2' | 'eleven_voice_isolation' | 'eleven_voice_dubbing' | 'eleven_multilingual_sts_v2' | 'gwm1_avatars' | 'voice_processing'>;
...
export declare namespace OrganizationRetrieveUsageResponse {
    ...
    namespace Result {
        interface UsedCredit {
             ...
             */
            model: 'gen4.5' | 'gen3a_turbo' | 'gen4_turbo' | 'gen4_image' | 'gen4_image_turbo' | 'act_two' | 'gen4_aleph' | 'veo3' | 'veo3.1' | 'veo3.1_fast' | 'gemini_2.5_flash' | 'eleven_multilingual_v2' | 'eleven_text_to_sound_v2' | 'eleven_voice_isolation' | 'eleven_voice_dubbing' | 'eleven_multilingual_sts_v2' | 'gwm1_avatars' | 'voice_processing';
        }
    }
}
